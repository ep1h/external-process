...
;
; @brief
;   The file contains the source code of a simple trainer for the FlatOut 2.
;   All addresses are obtained by reverse engineering the binary of the
;   game of the current version from Steam.
;   This is just a demonstration of the capabilities of the ExternalProcess
;   class using a real example. The trainer can and should be improved.
;
; @usage
;   F1 - Repair player's vehicle.
;   F2 - More efficient acceleration.
;   F3 - More efficient nitro.
;   F4 - Destroy opponents.
;   F5 - Swap player with the nearest opponent.
