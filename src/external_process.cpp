...
static tNtAllocateVirtualMemory NtAllocateVirtualMemory =
    (tNtAllocateVirtualMemory)GetProcAddress(LoadLibraryA("ntdll.dll"),
                                             "NtAllocateVirtualMemory");

static tNtFreeVirtualMemory NtFreeVirtualMemory =
    (tNtFreeVirtualMemory)GetProcAddress(LoadLibraryA("ntdll.dll"),
                                         "NtFreeVirtualMemory");

static tNtProtectVirtualMemory NtProtectVirtualMemory =
    (tNtProtectVirtualMemory)GetProcAddress(LoadLibraryA("ntdll.dll"),
